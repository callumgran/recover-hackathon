...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        if val_score > best_score:
            ...
            torch.save(model.state_dict(), "best_model_1024.pth")
    ...
    print("Model saved to: best_model_1024.pth")

    print("\nRunning final validation with best model...")
    model.load_state_dict(torch.load("best_model_1024.pth", map_location=device))
